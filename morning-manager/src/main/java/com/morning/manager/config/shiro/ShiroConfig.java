package com.morning.manager.config.shiro;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.morning.manager.entity.Resource> list = resourceService.findAll();
		for (com.morning.manager.entity.Resource resource : list) {
