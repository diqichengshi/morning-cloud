...
<div class="layui-form layui-form-pane" style="padding-top: 20px;margin-left: 10px;margin-right: 10px">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">状态<span style="color:#FF3E96">*</span></label>
        ...
        <#elseif item.propertyName == pkColumn.propertyName
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="${item.propertyName}" <#if item.nullable=="N">lay-verify="required"</#if> placeholder="请输入${item.comments!""}" autocomplete="on"
                       class="layui-input"/>
        </div>
    </div>
        </#if>
