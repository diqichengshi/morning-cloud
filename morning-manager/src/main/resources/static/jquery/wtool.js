(function (window) {
    ...
    wData.urlPath = {
        ...
        submit: "/agent/recharge/pay/online",
        get2Dcode: "/agent/recharge/pay/weChatPay/pay/pay",
        getBankList: "../pay/queryPayChannelList.do",
        getOrderInfo:'../pay/getOrderInfo.do',
        resendSms:'/agent/recharge/pay/paymentSubmitJson',
        pay:'/agent/recharge/pay/waitResultJson',
        checkBankCard:'/agent/recharge/pay/checkCardBin',
        getQpayStatus:'../../agent/recharge/pay/queryPayResult.do',
        onlinePay:'../../agent/recharge/pay/online/pay.do',
        getBankMsgList:'../bankMsgList',
        getPayTransferSerialNo:'/agent/recharge/pay/getPayTransferSerialNo',

        //B2C网银
        queryOrderBankList: '/agent/recharge/pay/online/queryOrderBankList.json',  //查询交易信息和绑卡信息
        onlinebankpay: '/agent/recharge/pay/online/onlineBankpay.json',  //网银跳转
