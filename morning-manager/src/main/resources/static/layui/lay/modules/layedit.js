...
;layui.define(["layer", "form"], function (t) {
    ...
    var s = function (t, i, a) {
                ...
                layui.use("upload", function (o) {
                    ...
                    o.render({
                        ...
                        elem: e(n).find("input")[0],
                            ...
                            0 == e.code ? (e.data = e.data || {}, v.call(t, "a", {
                                href: e.data.href,
                                text: e.data.title

                            }, a)) : i.msg(e.message || "上传失败")
                        }
                    })
                })
            }
        ...
        files: '<i class="layui-icon layedit-tool-image" title="附件" layedit-event="files">&#xe655;<input type="file" name="files"></i>',
