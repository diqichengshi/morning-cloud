...
layui.define(['table', 'form'], function (exports) {
    ...
    var option = {
        ...
        , cols: [[
            ...
            , {field: 'code', title: '部门编号', align: 'center', width: 200}
            , {field: 'name', title: '部门名称', align: 'center', width: 200}
            , {field: 'parentCode', title: '上级部门编号', align: 'center', width: 200}
    ...
    table.on('tool(table-operation-organize-filter)', function (obj) {
        ...
        switch (obj.event) {
            case 'selectCode':
                ...
                parent.$('#seleteOrgCode').val(data.code);
                parent.$('#seleteOrgName').val(data.name);
